...
static void collectionFromString(const std::string &str, std::vector<typename Traits::Type> &collection,
                                 const char *del = "|")
{
    char *literal = strdup(str.c_str());
    for (const char *cstr = strtok(literal, del); cstr != NULL; cstr = strtok(NULL, del)) {
        typename Traits::Type value;
        if (audio_utilities::utilities::convertTo<std::string, typename Traits::Type>(cstr, value)) {
...
template <class Traits>
std::string collectionToString(const std::vector<typename Traits::Type> &collection, const char *del = "|")
{
    std::string literals;
...
public:
    ...
    typedef const std::map<T, const std::string> Table;
    ...
    static void collectionFromString(const std::string &str, Collection &collection, const char *del);
...
static std::vector<FormatTraits::Type> formatsFromString(const std::string &formats, const char *del = "|")
{
...
static std::vector<InputChannelTraits::Type> inputChannelMasksFromString(const std::string &inChannels,
                                                                         const char *del = "|")
{
...
static std::vector<OutputChannelTraits::Type> outputChannelMasksFromString(const std::string &outChannels,
                                                                           const char *del = "|")
{
